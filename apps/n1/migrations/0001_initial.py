...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="n1_n1mediaa_source__b814ab_idx",
                    ),
                    models.Index(
                        fields=["source_basename"],
                        name="n1_n1mediaa_source__c1913d_idx",
                    ),
                ],
            },
        ),
        ...
        migrations.AddIndex(
            model_name="n1question",
            index=models.Index(
                fields=["exam", "kind"], name="n1_n1questi_exam_id_577fbc_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="n1question",
            index=models.Index(
                fields=["exam", "display_order"], name="n1_n1questi_exam_id_394567_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="n1questionitem",
            index=models.Index(
                fields=["question", "item_order"], name="n1_n1questi_questio_76717d_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="n1questionitem",
        ...
        migrations.AddIndex(
            model_name="n1subcategory",
            index=models.Index(
                fields=["section", "source_key"], name="n1_n1subcat_section_27bc32_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="n1subcategory",
        ...
        migrations.AddIndex(
            model_name="n1exam",
            index=models.Index(
                fields=["subcategory", "slug"], name="n1_n1exam_subcate_938bd7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="n1exam",
            index=models.Index(
                fields=["source_kind"], name="n1_n1exam_source__4a32d7_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="n1exam",

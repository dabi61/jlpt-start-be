"""
Models for JLPT N5 practice dataset (reading/listening/grammar/vocabulary).
"""
from django.db import models


class N5Section(models.Model):
...
class N5Subcategory(models.Model):
    """Subcategory under a section (e.g., DoanVanNgan, NgheHieuChuDe)."""

    section = models.ForeignKey(N5Section, on_delete=models.CASCADE, related_name='subcategories')
...
class N5Exam(models.Model):
    """One source JSON dataset under a subcategory."""

    subcategory = models.ForeignKey(N5Subcategory, on_delete=models.CASCADE, related_name='exams')
...
class N5Question(models.Model):
    """Question block from source JSON (contains one or more question items)."""

    exam = models.ForeignKey(N5Exam, on_delete=models.CASCADE, related_name='questions')
...
class N5QuestionItem(models.Model):
    """Atomic question item inside `content` array."""

    question = models.ForeignKey(N5Question, on_delete=models.CASCADE, related_name='items')
...
class N5MediaAsset(models.Model):

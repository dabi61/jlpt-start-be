"""Serializers for N3 practice data APIs."""
...
class N3SectionSerializer(serializers.ModelSerializer):
    class Meta:
        model = N3Section
        fields = [
            'id',
...
class N3SubcategorySerializer(serializers.ModelSerializer):
...
class N3ExamSerializer(serializers.ModelSerializer):
...
class N3QuestionItemSerializer(serializers.ModelSerializer):
    class Meta:
        model = N3QuestionItem
        fields = [
            'id',
            'question',
            'item_order',
...
class N3QuestionListSerializer(serializers.ModelSerializer):
...
class N3QuestionSerializer(serializers.ModelSerializer):
    items = N3QuestionItemSerializer(many=True, read_only=True)
    exam_name = serializers.CharField(source='exam.name', read_only=True)
    section_code = serializers.CharField(source='exam.subcategory.section.code', read_only=True)
    subcategory_code = serializers.CharField(source='exam.subcategory.code', read_only=True)
...
class N3MediaAssetSerializer(serializers.ModelSerializer):
    class Meta:
        model = N3MediaAsset
        fields = [
            'id',

...
@admin.register(N4Section)
class N4SectionAdmin(admin.ModelAdmin):
    list_display = ('id', 'code', 'name', 'sort_order', 'updated_at')
    search_fields = ('code', 'name')
    ordering = ('sort_order', 'name')


@admin.register(N4Subcategory)
class N4SubcategoryAdmin(admin.ModelAdmin):
...
@admin.register(N4Exam)
class N4ExamAdmin(admin.ModelAdmin):
    list_display = (
...
@admin.register(N4Question)
class N4QuestionAdmin(admin.ModelAdmin):
...
@admin.register(N4QuestionItem)
class N4QuestionItemAdmin(admin.ModelAdmin):
...
@admin.register(N4MediaAsset)
class N4MediaAssetAdmin(admin.ModelAdmin):

"""
Models for JLPT N2 practice dataset (reading/listening/grammar/vocabulary).
"""
from django.db import models


class N2Section(models.Model):
...
class N2Subcategory(models.Model):
    """Subcategory under a section (e.g., DoanVanNgan, NgheHieuChuDe)."""

    section = models.ForeignKey(N2Section, on_delete=models.CASCADE, related_name='subcategories')
...
class N2Exam(models.Model):
    """One source JSON dataset under a subcategory."""

    subcategory = models.ForeignKey(N2Subcategory, on_delete=models.CASCADE, related_name='exams')
...
class N2Question(models.Model):
    """Question block from source JSON (contains one or more question items)."""

    exam = models.ForeignKey(N2Exam, on_delete=models.CASCADE, related_name='questions')
...
class N2QuestionItem(models.Model):
    """Atomic question item inside `content` array."""

    question = models.ForeignKey(N2Question, on_delete=models.CASCADE, related_name='items')
...
class N2MediaAsset(models.Model):

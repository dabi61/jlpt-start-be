...
from .serializers import (
    N4SectionSerializer,
    N4SubcategorySerializer,
    N4ExamSerializer,
    N4QuestionListSerializer,
    N4QuestionSerializer,
    N4QuestionItemSerializer,
    N4MediaAssetSerializer,
)


class N4SectionViewSet(viewsets.ModelViewSet):
...
class N4SubcategoryViewSet(viewsets.ModelViewSet):
...
class N4ExamViewSet(viewsets.ModelViewSet):
    ...
    def questions(self, request, pk=None):
        ...
        serializer = N4QuestionListSerializer(page if page is not None else queryset, many=True)
        if page is not None:
...
class N4QuestionViewSet(viewsets.ModelViewSet):
    ...
    def get_serializer_class(self):
        if self.action == 'list':
            return N4QuestionListSerializer
        return N4QuestionSerializer
    ...
    def items(self, request, pk=None):
        ...
        serializer = N4QuestionItemSerializer(queryset, many=True)
        return Response(serializer.data)


class N4QuestionItemViewSet(viewsets.ModelViewSet):
    queryset = N4QuestionItem.objects.select_related(
...
class N4MediaAssetViewSet(viewsets.ModelViewSet):

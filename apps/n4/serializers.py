"""Serializers for N4 practice data APIs."""
...
class N4SectionSerializer(serializers.ModelSerializer):
    class Meta:
        model = N4Section
        fields = [
            'id',
...
class N4SubcategorySerializer(serializers.ModelSerializer):
...
class N4ExamSerializer(serializers.ModelSerializer):
...
class N4QuestionItemSerializer(serializers.ModelSerializer):
    class Meta:
        model = N4QuestionItem
        fields = [
            'id',
            'question',
            'item_order',
...
class N4QuestionListSerializer(serializers.ModelSerializer):
...
class N4QuestionSerializer(serializers.ModelSerializer):
    items = N4QuestionItemSerializer(many=True, read_only=True)
    exam_name = serializers.CharField(source='exam.name', read_only=True)
    section_code = serializers.CharField(source='exam.subcategory.section.code', read_only=True)
    subcategory_code = serializers.CharField(source='exam.subcategory.code', read_only=True)
...
class N4MediaAssetSerializer(serializers.ModelSerializer):
    class Meta:
        model = N4MediaAsset
        fields = [
            'id',

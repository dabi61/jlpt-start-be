"""Serializers for N5 practice data APIs."""
...
class N5SectionSerializer(serializers.ModelSerializer):
    class Meta:
        model = N5Section
        fields = [
            'id',
...
class N5SubcategorySerializer(serializers.ModelSerializer):
...
class N5ExamSerializer(serializers.ModelSerializer):
...
class N5QuestionItemSerializer(serializers.ModelSerializer):
    class Meta:
        model = N5QuestionItem
        fields = [
            'id',
            'question',
            'item_order',
...
class N5QuestionListSerializer(serializers.ModelSerializer):
...
class N5QuestionSerializer(serializers.ModelSerializer):
    items = N5QuestionItemSerializer(many=True, read_only=True)
    exam_name = serializers.CharField(source='exam.name', read_only=True)
    section_code = serializers.CharField(source='exam.subcategory.section.code', read_only=True)
    subcategory_code = serializers.CharField(source='exam.subcategory.code', read_only=True)
...
class N5MediaAssetSerializer(serializers.ModelSerializer):
    class Meta:
        model = N5MediaAsset
        fields = [
            'id',

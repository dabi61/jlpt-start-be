"""
Models for JLPT N3 practice dataset (reading/listening/grammar/vocabulary).
"""
from django.db import models


class N3Section(models.Model):
...
class N3Subcategory(models.Model):
    """Subcategory under a section (e.g., DoanVanNgan, NgheHieuChuDe)."""

    section = models.ForeignKey(N3Section, on_delete=models.CASCADE, related_name='subcategories')
...
class N3Exam(models.Model):
    """One source JSON dataset under a subcategory."""

    subcategory = models.ForeignKey(N3Subcategory, on_delete=models.CASCADE, related_name='exams')
...
class N3Question(models.Model):
    """Question block from source JSON (contains one or more question items)."""

    exam = models.ForeignKey(N3Exam, on_delete=models.CASCADE, related_name='questions')
...
class N3QuestionItem(models.Model):
    """Atomic question item inside `content` array."""

    question = models.ForeignKey(N3Question, on_delete=models.CASCADE, related_name='items')
...
class N3MediaAsset(models.Model):

"""
Models for JLPT N4 practice dataset (reading/listening/grammar/vocabulary).
"""
from django.db import models


class N4Section(models.Model):
...
class N4Subcategory(models.Model):
    """Subcategory under a section (e.g., DoanVanNgan, NgheHieuChuDe)."""

    section = models.ForeignKey(N4Section, on_delete=models.CASCADE, related_name='subcategories')
...
class N4Exam(models.Model):
    """One source JSON dataset under a subcategory."""

    subcategory = models.ForeignKey(N4Subcategory, on_delete=models.CASCADE, related_name='exams')
...
class N4Question(models.Model):
    """Question block from source JSON (contains one or more question items)."""

    exam = models.ForeignKey(N4Exam, on_delete=models.CASCADE, related_name='questions')
...
class N4QuestionItem(models.Model):
    """Atomic question item inside `content` array."""

    question = models.ForeignKey(N4Question, on_delete=models.CASCADE, related_name='items')
...
class N4MediaAsset(models.Model):
